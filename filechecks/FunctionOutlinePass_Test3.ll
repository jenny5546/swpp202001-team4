...
; CHECK-NEXT: r1 = icmp eq arg1 0 64
; CHECK-NEXT: store 8 r1 sp 0
; CHECK-NEXT: store 8 arg2 sp 88
...
if.end: 
; CHECK:   r1 = icmp eq arg2 0 64
; CHECK-NEXT:   store 8 r1 sp 8
; CHECK-NEXT:   store 8 arg1 sp 88
; CHECK-NEXT:   r1 = load 8 sp 88
; CHECK-NEXT:   store 8 r1 sp 80
; CHECK-NEXT:   r1 = load 8 sp 8
; CHECK-NEXT:   br r1 .return .if.end3                                          ; preds = %entry
...
return: 
; CHECK:   r1 = load 8 sp 80
; CHECK-NEXT:   ret r1                                          ; preds = %if.end7, %if.then2, %if.then
