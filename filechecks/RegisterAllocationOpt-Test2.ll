...
; CHECK-NEXT:     r2 = add r9 0 64
; CHECK-NEXT:     r4 = add r9 1 64
; CHECK-NEXT:     r6 = add r9 2 64
; CHECK-NEXT:     r8 = add r9 3 64
; CHECK-NEXT:     r3 = add r9 4 64
; CHECK-NEXT:     r7 = add r9 5 64
; CHECK-NEXT:     r5 = add r9 6 64
; CHECK-NEXT:     store 8 r2 sp 0
; CHECK-NEXT:     r2 = add r9 7 64
; CHECK-NEXT:     store 8 r4 sp 8
; CHECK-NEXT:     r4 = add r9 8 64
; CHECK-NEXT:     store 8 r6 sp 16
; CHECK-NEXT:     r6 = add r9 9 64
; CHECK-NEXT:     store 8 r8 sp 24
; CHECK-NEXT:     r8 = add r9 10 64
; CHECK-NEXT:     store 8 r3 sp 32
; CHECK-NEXT:     r3 = add r9 11 64
; CHECK-NEXT:     store 8 r7 sp 40
; CHECK-NEXT:     r7 = add r9 12 64
; CHECK-NEXT:     store 8 r5 sp 48
; CHECK-NEXT:     r5 = add r9 13 64
; CHECK-NEXT:     store 8 r2 sp 56
; CHECK-NEXT:     r2 = add r9 14 64
; CHECK-NEXT:     store 8 r4 sp 64
; CHECK-NEXT:     r4 = add r9 15 64
; CHECK-NEXT:     store 8 r6 sp 72
; CHECK-NEXT:     r6 = add r9 16 64
; CHECK-NEXT:     store 8 r8 sp 80
; CHECK-NEXT:     r8 = add r9 17 64
; CHECK-NEXT:     store 8 r3 sp 88
; CHECK-NEXT:     r3 = add r9 18 64
; CHECK-NEXT:     store 8 r7 sp 96
; CHECK-NEXT:     r7 = add r9 19 64
; CHECK-NEXT:     store 8 r5 sp 104
; CHECK-NEXT:     r5 = add r9 20 64
; CHECK-NEXT:     store 8 r2 sp 112
; CHECK-NEXT:     r2 = add r9 21 64
; CHECK-NEXT:     store 8 r4 sp 120
; CHECK-NEXT:     r4 = add r9 22 64
; CHECK-NEXT:     store 8 r6 sp 128
; CHECK-NEXT:     r6 = add r9 23 64
; CHECK-NEXT:     store 8 r8 sp 136
; CHECK-NEXT:     r8 = add r9 24 64
; CHECK-NEXT:     store 8 r3 sp 144
; CHECK-NEXT:     r3 = add r9 25 64
; CHECK-NEXT:     store 8 r7 sp 152
; CHECK-NEXT:     r7 = add r9 26 64
; CHECK-NEXT:     store 8 r5 sp 160
; CHECK-NEXT:     r5 = add r9 27 64
; CHECK-NEXT:     store 8 r2 sp 168
; CHECK-NEXT:     r2 = add r9 28 64
; CHECK-NEXT:     store 8 r4 sp 176
; CHECK-NEXT:     r4 = add r9 29 64
; CHECK-NEXT:     store 8 r6 sp 184
; CHECK-NEXT:     r6 = add r9 30 64
; CHECK-NEXT:     store 8 r8 sp 192
; CHECK-NEXT:     r8 = add r9 31 64
; CHECK-NEXT:     store 8 r3 sp 200
; CHECK-NEXT:     r3 = add r9 32 64
; CHECK-NEXT:     store 8 r7 sp 208
; CHECK-NEXT:     r7 = add r9 33 64
; CHECK-NEXT:     store 8 r5 sp 216
; CHECK-NEXT:     r5 = add r9 34 64
; CHECK-NEXT:     store 8 r2 sp 224
; CHECK-NEXT:     r2 = add r9 35 64
; CHECK-NEXT:     store 8 r4 sp 232
; CHECK-NEXT:     r4 = add r9 36 64
; CHECK-NEXT:     store 8 r6 sp 240
; CHECK-NEXT:     r6 = add r9 37 64
; CHECK-NEXT:     store 8 r8 sp 248
; CHECK-NEXT:     r8 = add r9 38 64
; CHECK-NEXT:     store 8 r3 sp 256
; CHECK-NEXT:     r3 = add r9 39 64
; CHECK-NEXT:     store 8 r7 sp 264
...
; CHECK-NEXT:     store 8 r5 sp 272
; CHECK-NEXT:     r5 = add r9 48 64
; CHECK-NEXT:     store 8 r2 sp 280
; CHECK-NEXT:     r2 = add r9 49 64
; CHECK-NEXT:     r7 = load 8 sp 0
...
; CHECK-NEXT:     r8 = load 8 sp 24
; CHECK-NEXT:     call write r8
; CHECK-NEXT:     store 8 r3 sp 312
...
; CHECK-NEXT:     store 8 r5 sp 328
; CHECK-NEXT:     r5 = load 8 sp 48
; CHECK-NEXT:     call write r5
; CHECK-NEXT:     store 8 r2 sp 336
; CHECK-NEXT:     r2 = load 8 sp 56
; CHECK-NEXT:     call write r2
; CHECK-NEXT:     store 8 r7 sp 0
; CHECK-NEXT:     r7 = load 8 sp 64
; CHECK-NEXT:     call write r7
; CHECK-NEXT:     store 8 r4 sp 8
; CHECK-NEXT:     r4 = load 8 sp 72
; CHECK-NEXT:     call write r4
; CHECK-NEXT:     store 8 r6 sp 16
; CHECK-NEXT:     r6 = load 8 sp 80
; CHECK-NEXT:     call write r6
; CHECK-NEXT:     store 8 r8 sp 24
; CHECK-NEXT:     r8 = load 8 sp 88
; CHECK-NEXT:     call write r8
; CHECK-NEXT:     store 8 r3 sp 32
; CHECK-NEXT:     r3 = load 8 sp 96
; CHECK-NEXT:     call write r3
...
; CHECK-NEXT:     call write r2
; CHECK-NEXT:     store 8 r7 sp 64
; CHECK-NEXT:     r7 = load 8 sp 128
; CHECK-NEXT:     call write r7
; CHECK-NEXT:     store 8 r4 sp 72
; CHECK-NEXT:     r4 = load 8 sp 136
; CHECK-NEXT:     call write r4
; CHECK-NEXT:     store 8 r6 sp 80
; CHECK-NEXT:     r6 = load 8 sp 144
; CHECK-NEXT:     call write r6
; CHECK-NEXT:     store 8 r8 sp 88
; CHECK-NEXT:     r8 = load 8 sp 152
; CHECK-NEXT:     call write r8
; CHECK-NEXT:     store 8 r3 sp 96
; CHECK-NEXT:     r3 = load 8 sp 160
; CHECK-NEXT:     call write r3
...
; CHECK-NEXT:     call write r2
; CHECK-NEXT:     store 8 r7 sp 128
; CHECK-NEXT:     r7 = load 8 sp 192
; CHECK-NEXT:     call write r7
; CHECK-NEXT:     store 8 r4 sp 136
; CHECK-NEXT:     r4 = load 8 sp 200
; CHECK-NEXT:     call write r4
; CHECK-NEXT:     store 8 r6 sp 144
; CHECK-NEXT:     r6 = load 8 sp 208
; CHECK-NEXT:     call write r6
; CHECK-NEXT:     store 8 r8 sp 152
; CHECK-NEXT:     r8 = load 8 sp 216
; CHECK-NEXT:     call write r8
; CHECK-NEXT:     store 8 r3 sp 160
; CHECK-NEXT:     r3 = load 8 sp 224
; CHECK-NEXT:     call write r3
...
; CHECK-NEXT:     call write r2
; CHECK-NEXT:     store 8 r7 sp 192
; CHECK-NEXT:     r7 = load 8 sp 256
; CHECK-NEXT:     call write r7
; CHECK-NEXT:     store 8 r4 sp 200
; CHECK-NEXT:     r4 = load 8 sp 264
; CHECK-NEXT:     call write r4
; CHECK-NEXT:     store 8 r6 sp 208
; CHECK-NEXT:     r6 = load 8 sp 272
; CHECK-NEXT:     call write r6
; CHECK-NEXT:     store 8 r8 sp 216
; CHECK-NEXT:     r8 = load 8 sp 280
; CHECK-NEXT:     call write r8
; CHECK-NEXT:     store 8 r3 sp 224
; CHECK-NEXT:     r3 = load 8 sp 288
; CHECK-NEXT:     call write r3
...
; CHECK-NEXT:     store 8 r7 sp 256
; CHECK-NEXT:     r7 = load 8 sp 320
; CHECK-NEXT:     call write r7
; CHECK-NEXT:     store 8 r4 sp 264
; CHECK-NEXT:     r4 = load 8 sp 328
; CHECK-NEXT:     call write r4
